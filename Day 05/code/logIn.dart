import 'package:foemvalidation/signUp.dart';
...
String npass="";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     appBar: AppBar(
       title: Text("Log in",style: TextStyle(fontWeight: FontWeight.bold,color:Colors.white),),
                    ...
                    TextFormField(
                      ...
                      focusedBorder: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(color: Color.fromARGB(255, 165, 19, 133)),
                               ...
                               validator:(value){
                                  MySharedPreferences.instance.getStringValue("oemail").then((val) => setState(() {
                                    nemail = val;
                                            }));
                    ...
                    TextFormField(
                      ...
                      focusedBorder: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(color: Color.fromARGB(255, 165, 19, 133)),
                             ...
                             validator: (value){
                                MySharedPreferences.instance.getStringValue("opass").then((val) => setState(() {
                              npass = val;
                               }));
