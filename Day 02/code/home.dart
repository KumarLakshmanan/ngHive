...
class _MyappState extends State<Myapp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(
     ...
     ListTile(
        leading:IconButton(icon: Icon(Icons.person,color: Colors.green,),
      onPressed: (){},),
       title: Text("user2"),
     ),
 ListTile(
     ...
     ListTile(
        leading:IconButton(icon: Icon(Icons.contacts,color: Colors.green,),
      onPressed: (){},),
       title: Text("user2"),
     ),
 ListTile(
     ...
     ListTile(
       ...
       Container(
        ...
        child: Icon(Icons.account_circle_rounded,size: 120,color: Colors.grey,),
           ...
           Divider(
             ...
             title: Text("Bio",style: TextStyle(color: Colors.green),),
             subtitle: Text(" "),
      ...
      onTap:(current_index){
        setState(() {
          index=current_index;
          page.animateToPage(index, duration: Duration(milliseconds: 300), curve: Curves.linearToEaseOut);
        }
